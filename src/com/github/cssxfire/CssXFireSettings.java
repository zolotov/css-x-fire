...
public class CssXFireSettings implements PersistentStateComponent<Element> {
  ...
  public static CssXFireSettings getInstance(@NotNull Project project) {
    return ServiceManager.getService(project, CssXFireSettings.class);
  }
  ...
  public void loadState(Element root) {
    ...
    this.autoExpand =
      general == null || general.getAttributeValue("autoExpand") == null || Boolean.parseBoolean(general.getAttributeValue("autoExpand"));
